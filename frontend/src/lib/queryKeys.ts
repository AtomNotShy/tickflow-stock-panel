...
export const QK = {
  ...
  aiResearchStatus:     ['ai-research-status'] as const,
  aiResearchCandidates: ['ai-research-candidates'] as const,
  aiResearchPortfolio:  ['ai-research-portfolio'] as const,
  aiResearchEvaluation: ['ai-research-evaluation'] as const,
